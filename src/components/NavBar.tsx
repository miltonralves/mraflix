  ...
  return (
    <nav className="navbar absolute top-0 left-0 grid grid-cols-2 items-center w-full py-4 px-8">
      <div className="justify-self-start grid grid-cols-2 gap-4 items-center">
        <h1 className="hidden">MraFlix</h1>
        <img src={logo} alt="MraFlix" />
      ...
      <div className="justify-self-end flex justify-items-end items-center">
        ...
        <div className="relative flex ml-4">
          <img src={placeholder} alt="Foto do usuário" onClick={handleClick} />
          <button onClick={handleClick}>
            <FontAwesomeIcon className="ml-2" icon={faCaretDown} />
          </button>
          <ul
            className={`absolute mt-10 top-0 right-0 w-32 h-auto bg-black rounded p-4 transition-all duration-500 ease-in-out ${
              !isMenuOpen && "opacity-0 invisebled"
            }`}
          >
            <li>
